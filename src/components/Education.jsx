  ...
  return (
    <>
        <div className='max-w-screen-md mx-auto p-5'>
            <h1 className='text-2xl font-bold text-[#222222]'>Education</h1>
                        ...
                        <div className='w-full mt-5 flex justify-between items-center'>
                            <div className='flex items-center'>
                                <div className='mr-2 border rounded-full'>
                                    <img src="/school-logo.jpeg" alt="collage-logo" className='w-14 h-14'/>
                                </div>
                            ...
                            <div>
                                <p className='text-[#64748B] text-md'>2019-2021</p>
                            </div>
                        </div>
                    </AccordionTrigger>
                    <AccordionContent>
                ...
                <AccordionItem value="item-1">
                    <AccordionTrigger>
                        <div className='w-full mt-5 flex justify-between items-center'>
                            <div className='flex items-center'>
                                <div className='mr-2 border rounded-full'>
                                    <img src="/kit-logo.jpeg" alt="collage-logo" className='w-14 h-14'/>
                                </div>
                                <div className='flex flex-col items-start'>
                            ...
                            <div>
                                <p className='text-[#64748B] text-md'>2022-2025</p>
                            </div>
                        </div>
                    </AccordionTrigger>
                    <AccordionContent>
